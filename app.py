    ...
    try:
        ...
        response = requests.post(
            ...
            json={
                "model": "anthropic/claude-3.5-sonnet",
                "messages": [
                    {"role": "system", "content": "You are a helpful assistant that provides detailed summaries of YouTube video transcripts. Your summaries should be comprehensive and cover all major points discussed in the video, without using bullet points or numbered lists."},
                    {"role": "user", "content": f"Please provide a detailed summary of the following YouTube video transcript. The summary should be thorough and cover all main topics and ideas presented in the video, but avoid using bullet points or numbered lists:\n\n{full_text}"}
                ]
            }
        )
